...
const HomePage = () => {
  return (
    <>
      <div className="grid grid-cols-4 h-screen place-content-center">
        <div className="col-span-2 justify-center items-center flex">
          <img
            src={jivan}
            alt=""
            className="h-96 w-[25vw] rounded-lg shadow-xl"
          />
        </div>
        <div className="col-span-2 text-xl">
          <div>
            <h1 className="text-green-700 mb-4 text-center text-6xl font-bold">
              Jivan Aryal
            </h1>
